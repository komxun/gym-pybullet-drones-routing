...
# track = p.loadURDF("samurai.urdf")


track = p.loadSDF("stadium.sdf", globalScaling=1)

otherCar = p.loadURDF("block.urdf", [0,1,.3], globalScaling=10)
car = p.loadURDF("block.urdf", [0,0,.3])
