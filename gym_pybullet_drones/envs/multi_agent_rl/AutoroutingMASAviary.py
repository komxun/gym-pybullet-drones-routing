...
from gym_pybullet_drones.envs.multi_agent_rl.ExtendedMultiagentAviary import ExtendedMultiagentAviary
from gym_pybullet_drones.routing.BaseRouting import RouteCommandFlag, RouteStatus

class AutoroutingMASAviary(ExtendedMultiagentAviary):
    ...
    def __init__(self,
                 ...
                 freq: int=240,
                 aggregate_phy_steps: int=2,  # used to be 1
                 gui=False,
                 record=False, 
