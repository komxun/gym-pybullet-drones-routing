...
if __name__ == "__main__":
    ...
    env = AutoroutingMASAviary(drone_model=ARGS.drone,
    ...
    # env = LeaderFollowerAviary(drone_model=ARGS.drone,
    #                     num_drones=ARGS.num_drones,
    ...
    for i in range(0, int(ARGS.duration_sec*env.SIM_FREQ), AGGR_PHY_STEPS):
        ...
        while not epEnd:
            #### Step the simulation ###################################
            action = {drone_idx: 6 for drone_idx in range(ARGS.num_drones)}
