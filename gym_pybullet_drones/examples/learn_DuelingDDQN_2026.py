...
for seed in SEEDS:
    ...
    environment_settings = {
        ...
        'max_minutes': 300,
        'max_episodes': 500,
        'goal_mean_100_reward': 100  # 150 to be determined properly
    }
    ...
    replay_buffer_fn = lambda: ReplayBuffer(max_size=2*50000, batch_size=64)
    n_warmup_batches = 5   
    update_target_every_steps = 30  # 1
    tau = 0.1
    ...
    make_env_fn, make_env_kargs = get_make_env_fn(env_name=env_name, num_drones=DEFAULT_AGENTS, render=False)
