...
def run(multiagent=DEFAULT_MA, output_folder=DEFAULT_OUTPUT_FOLDER, gui=DEFAULT_GUI, plot=True, colab=DEFAULT_COLAB, record_video=DEFAULT_RECORD_VIDEO, local=True):
    ...
    train_env = AutoroutingMARLAviary(
    ...
    #     policies={
    #         "policy_1": (
    #             None, train_env.observation_space, train_env.action_space, {"gamma": 0.80}
    #         ),
    #         "policy_2": (
    #             None, train_env.observation_space, train_env.action_space, {"gamma": 0.95}
    #         ),
    #     },
    ...
    if not multiagent:
        ...
        test_env = AutoroutingMARLAviary(gui=gui,
                                        num_drones=DEFAULT_AGENTS,
                                        obs=DEFAULT_OBS,
                                        act=DEFAULT_ACT,
                                        record=record_video)
        test_env_nogui = AutoroutingMARLAviary(num_drones=DEFAULT_AGENTS, obs=DEFAULT_OBS, act=DEFAULT_ACT)
