...
if __name__ == "__main__":
    ...
    parser.add_argument('--env',        default='ca_static',      type=str,             choices=['takeoff', 'hover', 'flythrugate', 'tune', 'ca_static'], help='Task (default: hover)', metavar='')
    parser.add_argument('--algo',       default='ddpg',        type=str,             choices=['a2c', 'ppo', 'sac', 'td3', 'ddpg'],        help='RL agent (default: ppo)', metavar='')
    ...
    render_env = AutoroutingAviary(aggregate_phy_steps=shared_constants.AGGR_PHY_STEPS, obs=ARGS.obs, act=ARGS.act, gui=True)
