...
if __name__ == "__main__":
    ...
    parser.add_argument('--algo',        default='DQN',              type=str,             choices=['cc'],                                     help='MARL approach (default: cc)', metavar='')
    ...
    config["multiagent"] = {
        "policies": {
            ...
            "pol0": (None, global_obs_space, action_space, {"agent_id": 0,}),
            "pol1": (None, global_obs_space, action_space, {"agent_id": 1,}),
        },
        "policy_mapping_fn": lambda agent_id: f"pol{agent_id}", # # Function mapping agent ids to policy ids
        "observation_fn": central_critic_observer,  # This gives global view during training
    }
